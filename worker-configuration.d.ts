/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0dcade809f9fe529f433fc63eaea9d71)
// Runtime types generated with workerd@1.20260918.1 2026-03-10 nodejs_compat
interface __BaseEnv_Env {
	PSN_AUTH_KV: KVNamespace;
	ASSETS: Fetcher;
	WEBSITE_URL: "https://obifortune.com";
	PUBLIC_SANITY_VISUAL_EDITING_ENABLED: false;
	PUBLIC_SANITY_API_PROJECT_ID: "gtsyvuts";
	PUBLIC_SANITY_API_DATASET: "production";
	PUBLIC_SANITY_API_VERSION: "2022-03-07";
	PUBLIC_POSTHOG_API_KEY: "phc_tsOUKsYrGpDKtq0LDG4uWzav1y8TwkHLRVadr8TIrv6";
	PUBLIC_POSTHOG_API_HOST: "https://p.obifortune.com";
	PUBLIC_POSTHOG_UI_HOST: "https://us.posthog.com";
	PUBLIC_PARTY_URL: "https://party.portfolio.obifortune.com";
	LASTFM_USER: "obifortune";
	LASTFM_API_KEY: string;
	PSN_NPSSO: string;
	SANITY_REVALIDATE_SECRET: string;
	SANITY_API_READ_TOKEN: string;
	WAKATIME_API_KEY: string;
	PSN_AUTH: DurableObjectNamespace<import("./src/worker").PsnAuth>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "PsnAuth";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WEBSITE_URL" | "PUBLIC_SANITY_VISUAL_EDITING_ENABLED" | "PUBLIC_SANITY_API_PROJECT_ID" | "PUBLIC_SANITY_API_DATASET" | "PUBLIC_SANITY_API_VERSION" | "PUBLIC_POSTHOG_API_KEY" | "PUBLIC_POSTHOG_API_HOST" | "PUBLIC_POSTHOG_UI_HOST" | "PUBLIC_PARTY_URL" | "LASTFM_USER" | "LASTFM_API_KEY" | "PSN_NPSSO" | "SANITY_REVALIDATE_SECRET" | "SANITY_API_READ_TOKEN" | "WAKATIME_API_KEY">> {}
}
